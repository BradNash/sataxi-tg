...
inputs = {
  ...
  source_repo_arn                 = "arn:aws:codecommit:eu-west-1:665316528893:insurance-service"
      ...
      actions = [
        {
          ...
          configuration = {
            ...
            UserParameters = jsonencode({
              ...
              ENV                       = "dev"
              TASK_DEFINITION_FILE_PATH = "deploy/insurance-service/dev/task-definition.yaml"
              CONFIG_FILE_PATH          = "deploy/insurance-service/dev/config.yaml"
      ...
      actions = [
        {
          ...
          configuration = {
            ...
            UserParameters = jsonencode({
              ...
              SERVICE_NAME              = "insurance",
              ENV                       = "qa"
              TASK_DEFINITION_FILE_PATH = "deploy/insurance-service/qa/task-definition.yaml"
              CONFIG_FILE_PATH          = "deploy/insurance-service/qa/config.yaml"
              REPOSITORY_NAME           = local.repository_name
              COMMIT_HASH               = "#{build.COMMIT_HASH}"
              IMAGE_TAG                 = "#{build.IMAGE_TAG}"
            })
      ...
      actions = [
        {
          ...
          configuration = {
            ...
            UserParameters = jsonencode({
              ...
              SERVICE_NAME              = "insurance",
              ENV                       = "prod"
              TASK_DEFINITION_FILE_PATH = "deploy/insurance-service/prod/task-definition.yaml"
              CONFIG_FILE_PATH          = "deploy/insurance-service/prod/config.yaml"
              REPOSITORY_NAME           = local.repository_name
              COMMIT_HASH               = "#{build.COMMIT_HASH}"
              IMAGE_TAG                 = "#{build.IMAGE_TAG}"
            })
